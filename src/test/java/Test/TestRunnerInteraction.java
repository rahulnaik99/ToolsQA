...
@CucumberOptions(features = "src/test/resources/FeatureFiles/testInteractions.feature", glue = "stepDefinitions",
...
public class TestRunnerInteraction extends AbstractTestNGCucumberTests {
    @Override
